def find_closest_solution(target_sum):
    ...
    for x in range(-target_sum, target_sum+1):
        for y in range(-target_sum, target_sum+1):
            for z in range(-target_sum, target_sum+1):
...
if target_sum in results:
    ...
    if closest_solution:
        ...
        if is_close(closest_value, target_sum):
            print("The closest solution is:", closest_solution)
            print("The value of the closest solution is:", closest_value)
        ...
        print("No solutions found within the considered limits.")
